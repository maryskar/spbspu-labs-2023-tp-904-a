...
namespace kotova
{
  ...
  using cmd_same = void (*)(const std::vector< Polygon > &, const Polygon &, std::ostream &out);
  class CommandDictionary
  {
    ...
    private:
      ...
      void doCommandSame(std::string &cmd, const std::vector<Polygon> &polygons, const Polygon &pol, std::ostream &out) const;
  };
}
