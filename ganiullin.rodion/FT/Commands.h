...
namespace ganiullin {
  ...
  public:
    ...
    std::ostream& execCommand(const std::string&, DictOfFreqDicts&, std::istream&, std::ostream&) const;
  ...
  private:
    ...
    using FuncWithSub = void (*)(DictOfFreqDicts&, const SubCommandDict&, std::istream&, std::ostream&);
